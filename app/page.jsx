...
const services = [
  ['Companionship & conversation', 'Friendly visits that reduce loneliness, build confidence and bring warmth into the day.', Users],
  ['Home help & light housekeeping', 'Support with light cleaning, laundry, tidying and keeping the home comfortable.', Home],
  ['Shopping, errands & appointments', 'Help with shopping lists, prescription collections, local errands and getting organised.', ShoppingBasket],
  ['Meals, drinks & gentle routine', 'Preparing simple meals and drinks, plus kind prompts that support everyday wellbeing.', Coffee],
];
        ...
        <div className="serviceGrid">
          {services.map(([title, text, Icon]) => (
            <article className="serviceCard" key={title}>
              <div className="serviceImage"><Icon size={54}/></div>
